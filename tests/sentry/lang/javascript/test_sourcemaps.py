...
class FindSourceTest(TestCase):
    def test_simple(self):
        ...
        result = smap_view.lookup_token(1, 56)
        ...
        result = smap_view.lookup_token(1, 0)
        ...
        result = smap_view.lookup_token(1, 36)
        ...
        result = smap_view.lookup_token(1, 37)
        ...
        result = smap_view.lookup_token(1, 192)
...
class ParseIndexedSourcemapTest(TestCase):
    ...
    def test_exact_mappings(self):
        ...
        # one.js
        assert smap_view.lookup_token(1, 1) == \
    ...
    def test_fuzzy_mapping(self):
        ...
        # one.js
        assert smap_view.lookup_token(1, 20) == \
            Token(dst_line=0, dst_col=18, src='/the/root/one.js', src_line=0, src_col=21, src_id=0, name='bar')
        assert smap_view.lookup_token(1, 30) == \
            Token(dst_line=0, dst_col=28, src='/the/root/one.js', src_line=1, src_col=10, src_id=0, name='baz')
        assert smap_view.lookup_token(2, 12) == \
